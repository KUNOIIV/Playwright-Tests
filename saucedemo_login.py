...
with sync_playwright() as p:
    ...
    page.screenshot(path="C:\\Users\\danie\OneDrive\\Documents\\QA Job preparations\\QA Work\\cart.png")
    print("Saving PNG to selected drive")
    ...
    print("After logout - title:", page.title())
