...
#Created a class InventoryPage to ensure to define methods to automate it's tasks
    ...
    #Clicks continue shopping → back to inventory. Waits visible, expects "Products" title – no stuck cart.
    ...
    #Fills checkout form → waits for #finish button visible → clicks. Completes order clean
    ...
    #Opens sidebar → waits logout link visible → clicks. Expects login fields – back home, no hang